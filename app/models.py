...
from sqlalchemy import BigInteger, String, Boolean, func, DateTime, ForeignKey, Text, BigInteger
...
class User(BaseModel):
    ...
    avatar_id:Mapped[int] = mapped_column(ForeignKey("media.id",ondelete="SET NULL"),nullable=True)
    ...
    posts:Mapped[list["Post"]]=relationship("Post",back_populates="user",cascade="all,delete-orphan",passive_deletes=True)
    kasb:Mapped["Profession"] = relationship("Profession",back_populates="user")
    comment:Mapped[list["Comment"]]=relationship("Comment",back_populates="user",passive_deletes=True)
...
class Post(BaseModel):
    ...
    postmedia:Mapped[list["PostMedia"]]=relationship("PostMedia",back_populates="post")
...
class Media(Base):
    ...
    postmedia:Mapped[list["PostMedia"]]=relationship("PostMedia",back_populates="media")
